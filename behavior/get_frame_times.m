...
% end_frame_idx = ((3*60 + 0)*60 + 15)*50; % number of frames to keep
end_frame_idx = 244515;
...
[dig_data, header] = readIntanDig(data_dir); % read in all the frame times
frame_in = dig_data(1, :);
...
% check dt
frame_dt = (diff(frame_starts)) / header.sample_rate;
