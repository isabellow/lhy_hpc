...
#     active_cache_frac_all = np.append(active_cache_frac_all, pos_dict[bird]['active_cache_frac'])
...
f.savefig(f'{save_figs_dir}/width_by_depth_cache_active.png', dpi=400, bbox_inches='tight')
plt.show()
